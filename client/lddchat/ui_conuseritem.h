...
public:
    ...
    void setupUi(QWidget *ConUserItem)
    {
        ...
        red_point_lb = new QLabel(widget);
        red_point_lb->setObjectName(QString::fromUtf8("red_point_lb"));
        red_point_lb->setGeometry(QRect(27, 2, 30, 30));
        red_point_lb->setMinimumSize(QSize(30, 30));
        red_point_lb->setMaximumSize(QSize(30, 30));
